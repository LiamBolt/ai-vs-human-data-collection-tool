    ...
    <div className="p-6 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <Card>
            <CardHeader><h2 className="text-sm font-semibold text-text-primary">What counts as a deviation</h2></CardHeader>
            <CardBody>
              <ul className="flex flex-col gap-3 text-sm text-text-secondary">
                <li>Participant interrupted mid-session and resumed later</li>
                <li>Technical issue caused a page reload or data loss</li>
                <li>Proctor gave verbal guidance outside the script</li>
                <li>Group assignment was manually overridden</li>
                <li>Participant withdrew partway through a session</li>
                <li>Device or browser problem affected task timing</li>
              </ul>
              <p className="mt-4 text-xs text-text-disabled">When in doubt, log it. Over-logging is better than under-logging for research integrity.</p>
            </CardBody>
          </Card>
        </div>
      </div>
